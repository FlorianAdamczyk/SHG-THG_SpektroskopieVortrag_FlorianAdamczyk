  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.55\textwidth}
      \begin{itemize}
        ...
        \item Bewegung erzeugt zeitabhängige Polarisation $P(t)$ \parencite{WikipediaNonlinearOpticalProcess2006}
        % \pause
  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.52\textwidth}
      \begin{itemize}
        ...
        \item Phasenanpassung: Birefringenz oder QPM
        \item Typen: Kritisch (I/II), QPM
      \end{itemize}
    \column{0.46\textwidth}
      \begin{center}
...
\begin{frame}{Experimenteller Aufbau: SHG/THG}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.43\textwidth}
      \centering
        % Hier ggf. Schemazeichnung einfügen
        \includegraphics[width=0.95\textwidth]{Images/Experimental-setup-measuring-SHG-and-THG-intensity-relative-to-laser-energy.png}\\
